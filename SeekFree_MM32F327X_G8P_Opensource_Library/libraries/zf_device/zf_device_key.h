...
#define KEY_LIST                    { E2, E3, E4, E5, D3 }
...
#define KEY_UP                      KEY_DEFINE_UP
#define KEY_CONFIRM                 KEY_DEFINE_DOWN
#define KEY_BACK                    KEY_DEFINE_LEFT
#define KEY_DOWN                    KEY_DEFINE_RIGHT
#define KEY_MID                     KEY_DEFINE_MID
